...
class Rbac
{
    const PERMISSIONS = [
        ...
        'loan.approve' => 'Approve loan / advance requests',
    ...
    public static function roleMap(): array
    {
        ...
        return [
            ...
            'Project Manager' => ['organization.view', 'project.view', 'project.manage', 'project.worker', 'project.payroll'],
            'Project HR' => ['organization.view', 'project.view', 'project.worker', 'project.payroll'],
