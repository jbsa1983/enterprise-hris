...
const NAV: { label: string; perm?: string; href: (o?: number) => string }[] = [
  ...
  { label: "Project Workers", perm: "project.view", href: (o) => (o ? `/o/${o}/people?type=project` : "#") },
  { label: "Projects", perm: "project.view", href: (o) => (o ? `/o/${o}/projects` : "#") },
  ...
  { label: "Service Desk", perm: "service_desk.view", href: (o) => (o ? `/o/${o}/hr?tab=service` : "#") },
  { label: "Performance Reviews", perm: "performance.view", href: (o) => (o ? `/o/${o}/hr?tab=performance` : "#") },
  { label: "Approvals", perm: "approval.view", href: (o) => (o ? `/o/${o}/hr?tab=approvals` : "#") },
  ...
  { label: "SSS / PhilHealth / HDMF", perm: "payroll.view", href: (o) => (o ? `/o/${o}/remittances` : "#") },
