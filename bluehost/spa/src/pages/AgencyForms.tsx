...
type Tab = "sss" | "philhealth" | "pagibig";
  ...
  return (
    <AppShell orgId={orgId}>
      <div className="mb-4">
        ...
        <p className="text-sm text-slate-500">SSS R-3, PhilHealth RF-1 and Pag-IBIG MCRF, generated from posted payroll. Employee shares come from payroll; employer shares are computed from the statutory rates.</p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b text-left text-xs uppercase tracking-wide text-slate-400">
                  <th className="py-2 pr-2">ID no.</th><th className="py-2 pr-2">Employee</th>
              ...
              {totals ? (
                <tfoot>
                  <tr className="font-semibold">
                    <td className="py-2 pr-2" colSpan={2}>{totals.count} members</td>
