// Lightweight API client. Tokens are stored in localStorage for the prototype.
// (A production build should prefer httpOnly cookies.)
...
// Fetch a binary endpoint (PDF/CSV/XLSX/ZIP) with auth and return a Blob.
...
// Trigger a browser download of a binary endpoint.
